...
puts "creating charities /w pics"
  ...
  Charity.create!(name: "Feeding America", category: "Food", description: "WHO WE ARE:  Feeding America is a nationwide network of 200 member food banks that leads the fight against hunger in the United States. Together, we provide food to more than 46 million people, including 11 million children and 7 million seniors, through 60,000 food pantries and meal programs and engage more than 2 million volunteers monthly in communities across the U.S. Feeding America also supports programs that improve food security among the people we serve; educates the public about the issue of hunger; and advocates for legislation that protects people from going hungry. 
    ...
    Then, coordinate transportation of donations to member food banks, which ensure the safe storage and reliable distribution of food to local food pantries and meal programs, which in turn, provide the food and grocery items directly to people in need in local communities across the U.S.
  ...
  Charity.create!(name: "Foundation Fighting Blindness, Inc.", category: "Health", description: "The Foundation Fighting Blindness was established in 1971 by a passionate group of families driven to find treatments and cures for inherited retinal diseases that were affecting their loved ones. At that time, little was known about these blinding retinal degenerative diseases. Very little research was being done, and there were no clinical trials for potential treatments.
    ...
    Today, the Foundation Fighting Blindness is the world’s leading private funder of retinal disease research. That funding has been a driving force behind the progress toward cures, including the identification of more than 270 genes linked to retinal disease, and the launch of more than 35 clinical trials for potential treatments.
    
    On an annual basis, the Foundation funds more than 75 research grants. The research projects are conducted by more than 90 research investigators at institutions, eye hospitals, and universities in the United States, Australia, England, France, Germany, The Netherlands, Italy, Israel, and Mexico.")
  Charity.last.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')
  ...
  Charity.create!(name: "Tuberous Sclerosis Alliance", category: "Health", description: "The Tuberous Sclerosis Alliance (TS Alliance) is the only national voluntary health organization for the genetic disorder known as tuberous sclerosis complex (TSC). It is also the leading organization for the funding of medical research related to TSC. Such medical research has included the breakthrough discovery of two genes (TSC1 and TSC2) that are known to cause the disorder.

  The TS Alliance was established in 1974 as the National Tuberous Sclerosis Association (NTSA), which it remained titled until 2000. Four mothers of children with TSC founded the organization in order to provide fellowship, generate awareness, pursue more knowledge and provide hope to those who share the common bond of facing the daily challenges of TSC.    
  
  Current Focus Today:
  
  The TS Alliance is overseen by a board of directors, whose role is to preserve the integrity of the TS Alliance, set policy, and support and promote the organization. The staff implements policies and priorities through the delivery of programs and services. During its more than 35 years of existence and growth, the TS Alliance has expanded its mission to improve the quality of life for individuals and families affected by tuberous sclerosis complex through the stimulation and sponsorship of research, the development of programs, support services and resource information, and the development and implementation of public and professional education programs designed to heighten awareness of TSC.         
  
  Programs and Support Services:
  
  The TS Alliance has an active government relations program through which it is striving to increase visibility of TSC in Congress and within the National Institutes of Health (NIH). The organization's goal is to engage government institutions in basic scientific and clinical research on causes and remedies for TSC. The TS Alliance builds networks through online services, conferences and volunteer outreach branches called Community Alliance to give the TSC-affected population a sense of community. Members and donors provide the necessary resources to meet the overall goals and objectives of the organization by their volunteer efforts and contributions.         
  
  Outreach and Advocacy:
  
  The TS Alliance outreach and advocacy program collaborates with individuals and families in their efforts to obtain entitlements (social security and medical benefits), appropriate educational opportunities (placements and vocational services), and transitional issues, which include housing and community connections.         
  ...
  Charity.create!(name: "American Center for Law and Justice (ACLJ)", category: "Legal", description: "Specializing in constitutional law, the ACLJ is dedicated to the concept that freedom and democracy are God-given inalienable rights that must be protected. The organization provides legal services at no charge for those who are persecuted in their efforts to spread the gospel. The American Center for Law and Justice is dedicated to the promotion of pro-liberty, pro-life, and pro-family causes. The organization defends religious liberties, human life, and the family in litigation cases all across the country. The ACLJ cooperates with other organizations that are committed to a similar mission, and ACLJ serves the public through educational efforts regarding First Amendment and religious freedom issues as well as other pro-family and pro-life concerns. As a not-for-profit organization that does not charge for its legal services, the ACLJ is dependent upon God and the resources He provides through the time, talent and gifts of people who share similar concerns over the erosion of religious and civil liberties.")
  Charity.last.photo.attach(io: file, filename: 'nes.png', content_type: 'image/png')

  file = URI.open('https://www.charities.org/sites/default/files/styles/logo/public/CureSearch-Full-logo-2015.jpg?itok=HaYnOA1S')
  Charity.create!(name: "Cancer Research for Children - CureSearch", category: "Legal", description: "More than 15,000 children are diagnosed with cancer annually. To save their child’s life, parents often have to consent to toxic therapies, knowing debilitating side effects are likely to follow their child throughout his or her life.
...
puts "creating charitys choices"
  ...
  CharitysChoice.create!(charity_id: 4, asset_id: 4)
  puts "4 finished"
  CharitysChoice.create!(charity_id: 5, asset_id: 3)
  CharitysChoice.create!(charity_id: 5, asset_id: 2)
  CharitysChoice.create!(charity_id: 5, asset_id: 1)
  puts "5 finished"
  CharitysChoice.create!(charity_id: 6, asset_id: 8)
  CharitysChoice.create!(charity_id: 6, asset_id: 5)
  CharitysChoice.create!(charity_id: 6, asset_id: 6)
  puts "6 finished"
  CharitysChoice.create!(charity_id: 7, asset_id: 2)
  CharitysChoice.create!(charity_id: 7, asset_id: 4)
  CharitysChoice.create!(charity_id: 7, asset_id: 3)
  puts "7 finished"
  CharitysChoice.create!(charity_id: 8, asset_id: 8)
  CharitysChoice.create!(charity_id: 8, asset_id: 4)
  CharitysChoice.create!(charity_id: 8, asset_id: 2)
  puts "8 finished"
  CharitysChoice.create!(charity_id: 9, asset_id: 8)
  CharitysChoice.create!(charity_id: 9, asset_id: 6)
  CharitysChoice.create!(charity_id: 9, asset_id: 7)
  puts "9 finished"
  CharitysChoice.create!(charity_id: 10, asset_id: 2)
  CharitysChoice.create!(charity_id: 10, asset_id: 3)
  CharitysChoice.create!(charity_id: 10, asset_id: 5)
...
puts "creating donation"
  ...
  Donation.create!(charity_id: 1, user_id: 1, asset_id: 1, donation_amount: 10, quantity: 1, order_status: "New")
  Donation.create!(charity_id: 2, user_id: 1, asset_id: 2, donation_amount: 1000, quantity: 3,  order_status: "Filled")
  Donation.create!(charity_id: 3, user_id: 1, asset_id: 4, donation_amount: 500, quantity: 1,  order_status: "Failed")
